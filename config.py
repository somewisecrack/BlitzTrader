...
PAIR_CREDIT_LEG_SELECTION = _optional_env("PAIR_CREDIT_LEG_SELECTION", "iv_expected_move")
...
PAIR_CREDIT_SELL_IV_MOVE = float(_optional_env("PAIR_CREDIT_SELL_IV_MOVE", "1.0"))
PAIR_CREDIT_HEDGE_MAX_IV_MOVE = float(_optional_env("PAIR_CREDIT_HEDGE_MAX_IV_MOVE", "2.5"))
PAIR_CREDIT_VOL_GATE_ENABLED = (
    _optional_env("PAIR_CREDIT_VOL_GATE_ENABLED", "false").lower()
    in {"1", "true", "yes", "on"}
)
...
NIFTY_FIRST_HOUR_MOMENTUM_CAPITAL = float(
    _optional_env("NIFTY_FIRST_HOUR_MOMENTUM_CAPITAL", "200000")
)
NIFTY_FIRST_HOUR_MOMENTUM_LEVERAGE = float(
    _optional_env("NIFTY_FIRST_HOUR_MOMENTUM_LEVERAGE", "5")
)
